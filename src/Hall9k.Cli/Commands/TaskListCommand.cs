...
public sealed class TaskListCommand : Hall9kAsyncCommand<TaskListCommand.Settings>
{
    ...
    public sealed class Settings : CommandSettings
    {
        ...
        [Description(
            ...
            + "Published, Working, Delivered, Waiting, HeldElsewhere, Done, Failed, Archived); Delivered is "
            + "pushed-but-not-merged, Waiting is a pr-review task whose posted review is waiting on its "
            + "author (PLAN.md #160), HeldElsewhere is a Claimed task another node currently holds (idea "
            + "202383dc, M2a), and Done means the merge was observed, the same bar the dependency rule uses "
            + "(PLAN.md #66). An "
            + "attention group selects the whole group h9k status counts by (" + TaskStateFilter.AttentionSpelling
            + "); the attention- spellings are the six groups the Status column names too, and the bare word "
