...
public sealed class ProjectSetCommand : Hall9kAsyncCommand<ProjectSetCommand.Settings>
{
    public sealed class Settings : CommandSettings
    {
        ...
        [Description(
            ...
            + "'/' matches any path under it, anchored at the repository root (docs/ style, not "
            + ".gitignore's match-at-any-depth); one with no '/' at all matches by file name alone "
            + "at any depth (*.md style); anything else matches against "
