...
/// <summary>
/// The session's terminal result carried the recognizable usage-limit message shape
/// (backlog 40): the subscription window ran dry mid-flight, not a machine or code fault. The run
