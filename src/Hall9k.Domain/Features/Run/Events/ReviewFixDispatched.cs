...
/// DaemonOptions.MaxAutomaticReviewFixRuns. Model is the resolved model this fix session was
/// spawned on, resolved for the Fix role in its own right, since a fix session and a review
