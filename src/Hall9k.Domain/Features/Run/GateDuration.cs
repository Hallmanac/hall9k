...
/// skipped a gate for this reason before host-coupled gates existed.
/// </summary>
public sealed record GateDuration(
    string Gate, TimeSpan Duration, bool Passed, bool RanFullScope = true, bool HostCoupledSkipped = false);
