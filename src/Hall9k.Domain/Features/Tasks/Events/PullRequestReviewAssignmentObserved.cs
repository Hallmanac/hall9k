...
/// amendment, and #161): a GitHub reviewer assignment to this install's own login, observed on a
/// registered project's repo, is what created and started this task — not a human typing
