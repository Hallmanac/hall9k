...
/// diff (Decisions Log #80) and every reader of it predates this field. Null on a manual reopen
/// and on events recorded before this field existed, which reads as "no thread detail observed"
/// — the posting path then has no provider-observed human thread to refuse on, exactly as it had
