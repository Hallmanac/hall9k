...
/// reason (Decisions Log #100: nothing closes an epic automatically, including its
...
public static class EpicDecider
{
    ...
    /// ever will (Decisions Log #100). The reference is stored exactly as typed —
    ...
    /// when its last member task closes out, not when every task leaves it (Decisions Log #100,
