...
public sealed class OperatingSettings
{
    ...
    /// </summary>
    public const int DefaultMaxAdversarialReviewCycles = 4;
    ...
    /// </summary>
    public const int DefaultMaxFinalFullPassRounds = 2;
    ...
    /// </summary>
    public const int DefaultLifetimeReviewCycleBudget = 20;
