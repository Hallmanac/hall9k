...
public static class EventScopeRegistry
{
    private static readonly IReadOnlyDictionary<Type, EventScope> Classifications = new Dictionary<Type, EventScope>
    {
        ...
        [typeof(PrReviewPersonaReported)] = EventScope.ProjectScoped,
        [typeof(PrReviewPersonaSessionFailed)] = EventScope.ProjectScoped,
        [typeof(PrReviewPersonasSelected)] = EventScope.ProjectScoped,
