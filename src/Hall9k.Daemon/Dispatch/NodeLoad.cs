...
public sealed record NodeLoad(int LiveRuns, int MaxConcurrentAgentSessions)
{
    ...
    /// hold" a guarantee rather than an average.
    /// </summary>
    ...
    /// <summary>How many more runs may start right now; never negative, since a resumed park can put the node over.</summary>
