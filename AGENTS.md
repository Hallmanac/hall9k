...
#64): the item's title seeds the objective, its description becomes agent context, and the item is
...
Jira is connected as a **read** credential plus an agent-mediated pen (Decisions Log #64), because
