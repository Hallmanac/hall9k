...
- An idea is concluded by an explicit human act - h9k idea conclude <id> --reason (discovery done, produced these) - or discarded as today; cutting a task never auto-ends the idea, because discovery may keep producing
...
- Concluding an idea with zero tasks cut is legal with a reason (discovery can honestly conclude "nothing to do here"), distinct from discard
