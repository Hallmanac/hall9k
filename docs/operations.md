...
Eight recovery levers, plus the review lap's own two verdict commands at the bottom of the table. Picking the wrong one loses work, and the question that separates them is *what
actually failed*.
